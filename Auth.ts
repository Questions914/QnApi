...
export class AuthClass {
    ...
    async begin(userId: string, handlers?: QnaHandlers) {
        try {
    ...
    async continue(code: string, handlers?: QnaHandlers) {
        try {
    ...
    async register(username: string, birthdate: string, gender: string, handlers?: QnaHandlers) {
        try {
    ...
    async ping(handlers?: QnaHandlers) {
        try {
    ...
    async logout(handlers?: QnaHandlers) {
        try {
